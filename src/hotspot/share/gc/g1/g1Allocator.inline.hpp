...
inline G1DataStructureRegionSet* G1PLABAllocator::data_structure_region_set(oop from_oop, oop to_oop, bool& is_new_root) const {
  return _data_structure_manager->get_data_structure(from_oop, to_oop, is_new_root);
}
